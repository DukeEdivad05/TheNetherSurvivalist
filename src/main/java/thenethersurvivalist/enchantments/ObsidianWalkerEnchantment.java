...
public class ObsidianWalkerEnchantment extends Enchantment {
    public ObsidianWalkerEnchantment(Enchantment.Rarity weight, EquipmentSlot... slotTypes) {
    ...
    public boolean isTreasure() {
        return !TheNetherSurvivalistSettings.ObsidianWalker;
    }
    ...
    public static void solidificateLava(LivingEntity entity, World world, BlockPos blockPos, int level) {
    ...
    public boolean canAccept(Enchantment other) {
        return super.canAccept(other) && other != Load.NETHER_DEPTH_STRIDER;
    }
}
